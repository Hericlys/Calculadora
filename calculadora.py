...
class Calculadora(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.add_btn(QPushButton("."), 5, 0, 1, 1)
    ...
    def add_btn(self, btn, linha, coluna, linspan, colspan, funcao=None, style=None):
        self.grid.addWidget(btn, linha, coluna, linspan, colspan)
        if not funcao:
            btn.clicked.connect(
                lambda: self.display.setText(
